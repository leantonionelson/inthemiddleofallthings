 ...
 */
export class GdmLiveAudioVisuals3D extends HTMLElement {
  ...
  private init() {
    ...
    // Create fallback sphere without EXR texture
    ...
    scene.add(sphere);
    sphere.visible = true; // Make visible immediately without EXR texture
    ...
    const onWindowResize = () => {
      ...
      (backdrop.material as any).uniforms.resolution.value.set(w * dPR, h * dPR);
