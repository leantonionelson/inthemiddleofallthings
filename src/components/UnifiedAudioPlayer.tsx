  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed bottom-0 left-0 right-0 z-[60] bg-paper-light/95 dark:bg-paper-dark/95 backdrop-blur-sm border-t border-ink-muted/20 dark:border-paper-light/20"
      >
